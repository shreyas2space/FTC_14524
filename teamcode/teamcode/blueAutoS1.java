...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "blueAutoS1", group = "Autonomous")
public class blueAutoS1 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Thread thread1 = new Thread() {
            public void run() {
                moveForward(0.7, -1800, 4.0);
                moveArm(0.5, 1050, 1.0);
                moveArm(0.5, -1050, 1.0);
                moveForward(0.7, 500, 5.0);
                moveStrafe(0.6, 5400, 6.0, false);
                moveForward(0.7, 600, 7.0);
                moveCarousel(0.7, 1400, 3.0);
                moveForward(0.7, -1400, 6.0);
