...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "redAutoS2", group = "Autonomous")
public class redAutoS2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Thread thread1 = new Thread() {
            public void run() {
                moveForward(0.7, -1600, 4.0);
                moveArm(0.5, 1300, 1.0);
                moveArm(0.5, -1300, 1.0);
                moveForward(0.7, 700, 5.0);
                moveTurn(0.5, 1200, 3.0, true);
